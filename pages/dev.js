...
export default class User extends React.Component {
    ...
    const requisicao = {
      ...
      object: {
        ...
        headers: {
          ...
          Authorization:
            "eyJhbGciOiJIUzI1NiJ9.eyJlbWFpbCI6InRpQGJvbml0b3VyLmNvbS5iciIsImV4cCI6MTU3OTA5MDg3M30.eyLkJgU6YKSuX5HQjuW3oCfl7GEpkKf_mGlQnVod7bY",
  ...
  defineImage() {
    ...
    if (this.props.user.arquivo_assinatura != null) {
      url_image =
        url_image + "/usuarios_fotos/" + this.props.user.arquivo_assinatura;
    } else {
